...
public class CriaPersonagens : MonoBehaviour
{
    ...
    public void CriaMya()
    {
        ...
        salvaJogoPC.SalvaPersonagemEscolhido(personagemList[0].id, personagemList[0].nome, personagemList[0].pais);
    }
    ...
    public void CriaMcDino()
    {
        ...
        salvaJogoPC.SalvaPersonagemEscolhido(personagemList[1].id, personagemList[1].nome, personagemList[1].pais);
    }

    public void CriaMelinda()
    {
        personagemList[2].id = 2;
        personagemList[2].nome = "Dalila";
        //personagemList[2].campanha = "Campanha_Melinda";
        personagemList[2].pais = "Argentina";

        salvaJogoPC.SalvaPersonagemEscolhido(personagemList[2].id, personagemList[2].nome, personagemList[2].pais);
    }
    ...
    public void CriaHekaib()
    {
        ...
        salvaJogoPC.SalvaPersonagemEscolhido(personagemList[3].id, personagemList[3].nome, personagemList[3].pais);
    }
}
